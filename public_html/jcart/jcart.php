...
$str_subtotal = number_format($this->subtotal, $priceFormat['decimals'], $priceFormat['dec_point'], $priceFormat['thousands_sep']);
...
<h3>Subtotal</h3>
<h3>MYR $str_subtotal</h3>
<p id="total_item">$this->itemCount</p>
</div>
...
if ($isCheckout === true) {
	...
	echo tab(3) . "<input type='$inputType' $src id='jcart-paypal-checkout' name='jcartPaypalCheckout' value='Offline Checkout' $disablePaypalCheckout />\n";
}
